        ...
        $http({
            ...
            $scope.hots.forEach(function(val, index, arr) {
                switch ($scope.hots[index].type) {
                    case 'mli':
                        $scope.hots[index].typeCn = '军事新闻';
                        break;
                    case 'edu':
                        $scope.hots[index].typeCn = '教育新闻';
                        break;
                    case 'sci':
                        $scope.hots[index].typeCn = '科技新闻';
                        break;
                    case 'eco':
                        $scope.hots[index].typeCn = '经济新闻';
                        break;
                    case 'spo':
                        $scope.hots[index].typeCn = '体育新闻';
                        break;
                    default:
                        $scope.hots[index].typeCn = '其他新闻';
                        break;
                }
            });
            data.mlis.name = '军事';
